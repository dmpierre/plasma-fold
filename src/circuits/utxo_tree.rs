/// This module defines the utxo tree. The utxo tree root is stored onchain. Updated to UTXO tree
/// are proven by the aggregator. Each proof posted by the aggregator is posted onchain and is used
/// to attest to the correctness of updates done to the utxo tree.
use std::usize;
...
#[derive(Debug, Clone)]
pub struct UTXOTree<P: Config> {
    pub root: P::InnerDigest, // root of the utxo tree
}
